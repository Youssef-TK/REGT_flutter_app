// // screens/referred_welcome_screen.dart
...
//         elevation: 0,
//         title: const Text('Welcome Gift 🎉', style: TextStyle(color: Colors.white)),
//         centerTitle: true,
//       ),
...
//               child: Column(
//                 children: [
//                   const Icon(Icons.card_giftcard, size: 80, color: Color(0xffFFD700)),
...
//                   const SizedBox(height: 16),
//                   const Text(
//                     "You both get bonus tokens when you start earning!",
...
//             // Your Referral Link Card (exact copy from your ReferralsScreen)
//             Container(
//               padding: const EdgeInsets.all(16),
//               decoration: BoxDecoration(
//                 gradient: const LinearGradient(colors: [Color(0xff1a1a1a), Color(0xff2a2a2a)]),
...
//                       SizedBox(width: 8),
//                       Text('Your Referral Code', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
//                     ],
//                   ),
//                   const SizedBox(height: 12),
//                   Container(
...
//                     child: Text(
//                       _referralLink,
//                       style: const TextStyle(color: Color(0xffFFD700), fontFamily: 'Courier', fontSize: 14),
//                     ),
//                   ),
//                   const SizedBox(height: 16),
//                   Row(
...
//             // Add Referral Code Card (only if they want to change/add another)
//             Container(
//               padding: const EdgeInsets.all(16),
//               decoration: BoxDecoration(
//                 gradient: const LinearGradient(colors: [Color(0xff1a1a1a), Color(0xff2a2a2a)]),
...
//                       SizedBox(width: 8),
//                       Text('Add Another Referral Code (Optional)', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
//                     ],
//                   ),
//                   const SizedBox(height: 12),
//                   TextField(
...
//                     ),
//                     child: const Text('Submit Code', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
//                   ),
//                 ],
//               ),
//             ),
