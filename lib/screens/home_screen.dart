...
//       if (configData != null) {
//         final double usdPrice = (configData['usd_regt_price'] as num? ?? 0.1)
//             .toDouble();
//         final double eurPrice = (configData['eur_regt_price'] as num? ?? 0.08)
//             .toDouble();
...
//               comm += (h['value'] as num? ?? 0).toDouble();
//             }
//           }
//         }
//         totalComm += comm;
...
//                     ),
//                     Text(
//                       '${formatNumber(_balanceOnHold)} REGT',
//                       style: const TextStyle(
...
//                           formattedApprovedDate = DateFormat(
//                             'dd/MM/yyyy',
//                           ).format(parsedApprovedAt);
//                           formattedApprovedTime = DateFormat(
//                             'hh:mm a',
//                           ).format(parsedApprovedAt);
//                         } catch (e) {
...
//                         }
//                       }
//                       final formattedRequestDate = DateFormat(
//                         'dd/MM/yyyy',
//                       ).format(parsedDate);
//                       final formattedRequestTime = DateFormat(
//                         'hh:mm a',
//                       ).format(parsedDate);
...
//                                 children: [
//                                   _buildDetailRow('Amount', '$amount REGT'),
